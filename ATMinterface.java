...
public class ATMinterface {
    ...
    public static void main(String [] args) {
        ...
        System.out.println("Dear Customer : Welcome to State Bank Of India  \n");
        System.out.println("Please enter your A.T.M pinNo :");

        pinNo = sc.nextInt();
        if(pinNo == 5678) {
            while(true) {
                System.out.println("State Bank Of India A.T.M ");
                ...
                switch(x) {
                    ...
                    case 5 :
                        System.out.println("Welcome to State Bank Of India A.T.M !!");
                        ...
                        System.out.println("Thanks For using State Bank Of India A.T.M ");
